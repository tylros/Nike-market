import { Hero, Services, SpecialOffer, Subscribe, SuperQuality, PopularProduts, CustomerReviews, Footer } from "./sections"; 
...
function App() {
  ...
  return (
    ...
    <Nav/>
      ...
      <section className="padding"><PopularProduts/></section>
